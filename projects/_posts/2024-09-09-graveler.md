...
Overall we have taken this solution from taking an estimated 1500 seconds to simulate a billion games all the way down to about 0.3 seconds, a speed improvement of over `5000×`, and approaching `3,000,000×` improvement over the original Python implementation.
